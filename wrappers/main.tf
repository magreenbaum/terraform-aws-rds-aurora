module "wrapper" {
  ...
  cluster_activity_stream                                = try(each.value.cluster_activity_stream, var.defaults.cluster_activity_stream, null)
  cluster_ca_cert_identifier                             = try(each.value.cluster_ca_cert_identifier, var.defaults.cluster_ca_cert_identifier, null)
  cluster_db_instance_parameter_group_name               = try(each.value.cluster_db_instance_parameter_group_name, var.defaults.cluster_db_instance_parameter_group_name, null)
  cluster_instance_class                                 = try(each.value.cluster_instance_class, var.defaults.cluster_instance_class, null)
  ...
  cluster_parameter_group                                = try(each.value.cluster_parameter_group, var.defaults.cluster_parameter_group, null)
  cluster_parameter_group_name                           = try(each.value.cluster_parameter_group_name, var.defaults.cluster_parameter_group_name, null)
  ...
  db_parameter_group                                     = try(each.value.db_parameter_group, var.defaults.db_parameter_group, null)
  ...
  instance_timeouts                                      = try(each.value.instance_timeouts, var.defaults.instance_timeouts, null)
  ...
  role_associations                                      = try(each.value.role_associations, var.defaults.role_associations, {})
  s3_import                                              = try(each.value.s3_import, var.defaults.s3_import, null)
  scaling_configuration                                  = try(each.value.scaling_configuration, var.defaults.scaling_configuration, null)
  ...
  serverlessv2_scaling_configuration                     = try(each.value.serverlessv2_scaling_configuration, var.defaults.serverlessv2_scaling_configuration, null)
  shard_group                                            = try(each.value.shard_group, var.defaults.shard_group, null)
